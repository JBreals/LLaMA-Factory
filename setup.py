...
extra_require = {
    ...
    "bitsandbytes": ["bitsandbytes>=0.45.3"],
    "hqq": ["hqq"],
    "eetq": ["eetq"],
    # Pin GPTQModel below 5.x since recent releases started depending on NumPy 2.2.6 and PyTorch 2.8,
    # which conflicts with the core requirement `numpy<2.0.0` and our CUDA 12.4 / torch 2.6 base image.
    "gptq": ["optimum>=1.24.0", "gptqmodel>=2.0.0,<5.0.0"],
    "aqlm": ["aqlm[gpu]>=1.1.0"],
